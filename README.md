...
**[Hello-React-Rails]** is a project with purpose of practice connecting FrontEnd with BackEnd connecting two projects using the endpoints
...
- VScode or other similia program
- Have installed Node.js, Ruby, React, Redux and all dependencies
...
[you can find the Backend repo here](https://github.com/Gdiazdiaz/Hello-Backend)
  ...
  git clone https://github.com/Gdiazdiaz/Hello-Backend.git
...
"http://127.0.0.1:3001/api/grettings" for the API
